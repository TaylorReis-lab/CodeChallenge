  ...
  return (
    <div className="max-w-4xl mx-auto space-y-8">
      ...
      <div className="text-center">
        ...
        <p className="text-slate-600">Conheça o JS Challenges e seu propósito</p>
      </div>
      ...
      <Card className="p-8">
        ...
        <p className="text-slate-600 leading-relaxed mb-6">
          O <strong>JS Challenges</strong> foi desenvolvido com o intuito de ajudar desenvolvedores a 
          <strong> relembrar e praticar funções e métodos do JavaScript</strong>. Seja você um iniciante 
          querendo solidificar seus conhecimentos ou um desenvolvedor experiente que precisa relembrar 
          alguma sintaxe específica, esta plataforma oferece desafios práticos organizados por nível de dificuldade.
        </p>
        ...
        <p className="text-slate-600 leading-relaxed">
          ...
          É como ter uma referência rápida do JavaScript sempre à mão!
        </p>
      </Card>
      ...
      <Card className="p-8">
        ...
        <div className="grid md:grid-cols-2 gap-4">
          <div className="bg-slate-50 p-4 rounded-lg">
            ...
            <p className="text-sm text-slate-600">split, join, slice, charAt, toUpperCase, toLowerCase, replace, e mais...</p>
          </div>
          <div className="bg-slate-50 p-4 rounded-lg">
            <h4 className="font-medium text-slate-800 mb-2">Arrays</h4>
            <p className="text-sm text-slate-600">map, filter, reduce, find, sort, flat, includes, indexOf, e mais...</p>
          </div>
          <div className="bg-slate-50 p-4 rounded-lg">
            <h4 className="font-medium text-slate-800 mb-2">Funções</h4>
            <p className="text-sm text-slate-600">closures, callbacks, recursão, currying, memoização, debounce...</p>
          </div>
          <div className="bg-slate-50 p-4 rounded-lg">
            <h4 className="font-medium text-slate-800 mb-2">Objetos</h4>
            <p className="text-sm text-slate-600">Object.keys, Object.values, Object.entries, spread, destructuring...</p>
          </div>
        </div>
      </Card>
      ...
      <Card className="p-8">
        ...
        <ul className="list-disc list-inside text-slate-600 space-y-2">
          ...
          <li><strong>🌱 Juninho Dev</strong> - Entre no nível intermediário</li>
          <li><strong>🦁 Programador Corajoso</strong> - Enfrente desafios avançados</li>
          <li><strong>🌟 Lenda do JavaScript</strong> - Complete TODOS os desafios</li>
        </ul>
      </Card>
      ...
      <Card className="p-8 bg-gradient-to-r from-slate-800 to-slate-900 text-white">
        ...
        <p className="text-slate-300 leading-relaxed mb-6">
          Este projeto é open source e está aberto para contribuições. Atualmente, sou eu quem está 
        ...
        <div className="bg-slate-700/50 rounded-xl p-4 mb-6">
          ...
          <div className="flex flex-wrap gap-2">
            <span className="px-3 py-1 bg-slate-600 rounded-full text-sm">C#</span>
