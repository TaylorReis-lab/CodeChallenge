...
export const javascriptChallenges: Challenge[] = [
  {
    ...
    documentation: {
      concept:
        'As funções são blocos de construção fundamentais em JavaScript. Uma função é um procedimento — um conjunto de enunciados que executa uma tarefa ou calcula um valor.',
      ...
      tips: ['Funções são reutilizáveis', 'Use return para retornar valores'],
    },
    xpReward: 10,
  },
  {
    ...
    documentation: {
      concept:
        'Operadores aritméticos realizam aritmética básica em números (literais ou variáveis).',
      syntax: 'let soma = a + b;',
      ...
      tips: ['Cuidado com strings vs números', 'Use Number() para converter'],
    },
    xpReward: 15,
  },
];
